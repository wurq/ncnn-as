...
Java_com_tencent_squeezencnn_MobileNetssd_Init(JNIEnv *env, jobject instance, jbyteArray param,
                                               jbyteArray bin) {
    // init param
    {
...
Java_com_tencent_squeezencnn_MobileNetssd_Detect(JNIEnv *env, jobject instance, jobject bitmap) {
